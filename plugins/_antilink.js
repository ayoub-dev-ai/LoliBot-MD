...
await conn.sendMessage(m.chat, { text: `*「 Link detected 」*\n\n${user} خرج ههه...`, mentions: [m.sender] }, { quoted: m, ephemeralExpiration: 24*60*100, disappearingMessagesInChat: 24*60*100 });
if (!isBotAdmin) return conn.sendMessage(m.chat, { text: `🚩 انا ماشي  ادمين.`, mentions: [...groupAdmins.map(v => v.id)] }, { quoted: m });
if (isBotAdmin) {
