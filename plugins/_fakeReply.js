...
global.canalIdGB = ["120363372688988248@newsletter", "120363372688988248@newsletter", "120363372688988248@newsletter"]
global.canalNombreGB = ["Ayoub dev 💫", "Abdo tech ☁️", "Jeen md ✨"]
global.channelRD = await getRandomChannel()
	
global.fkontak = { "key": { "participants":"0@s.whatsapp.net", "remoteJid": "status@broadcast", "fromMe": false, "id": "Halo" }, "message": { "contactMessage": { "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:Sy;Bot;;;\nFN:y\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD` }}, "participant": "0@s.whatsapp.net" }
	
global.rpl = { contextInfo: { externalAdReply: { mediaUrl: nna, mediaType: 'VIDEO', description: 'Update/news', title: packname, body: 'Channel whatsapp', thumbnailUrl: pp, sourceUrl: [nna, nna2, nnaa].getRandom() }}} 
...
global.rpyp = { contextInfo: { externalAdReply: { mediaUrl: md, mediaType: 'VIDEO', description: 'Abdo', title: 'Ayob', body: 'whatsapp bot 🌟', thumbnailUrl: pp, sourceUrl: md }}}
...
await this.reply(m.chat, [`*${this.user.name}* `boom`, `jeenmd ptm`, `*${this.user.name}* XD 🤣`].getRandom()) 
